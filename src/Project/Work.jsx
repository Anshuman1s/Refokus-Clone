  ...
  useMotionValueEvent(scrollYProgress, "change", (data) => {
    ...
    switch (val) {
      ...
      case 3:
        ...
        break;
      case 4:
        imagesLoading([0, 1, 2, 3]);
        break;
      case 5:
        imagesLoading([0, 1, 2, 3, 4]);
        break;
      case 6:
        imagesLoading([0, 1, 2, 3, 4, 5]);
        break;
      default:
        break;
    }
    ...
    <div className='w-full '>
      <div className="max-w-screen-xl mx-auto relative">
        ...
        <div className="w-full h-full absolute top-0">
          {img.map((elem, index) => (elem.isActive && (<img key={index} className='w-60 rounded-lg absolute -translate-x-[50%] -translate-y-[50%]' src={elem.url} style={{ top: elem.top, left: elem.left }} alt="" />)))}
        </div>
      </div>
    </div>
  );
